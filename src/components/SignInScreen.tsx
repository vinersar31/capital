  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-4">
      <div className="card w-full max-w-sm animate-fade-in-up p-8 text-center">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-400 to-brand-600 shadow-glow">
          <LineChart className="h-7 w-7 text-ink-950" strokeWidth={2.5} />
        </div>
        <h1 className="mt-5 text-2xl font-bold tracking-tight text-white">Capital</h1>
        <p className="mt-1 text-sm text-slate-400">
          Sign in to view and manage your holdings.
        </p>

        <button
          type="button"
          onClick={signIn}
          className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-slate-800 transition-transform hover:scale-[1.02] active:scale-95"
        >
          <GoogleIcon />
          Sign in with Google
        </button>
